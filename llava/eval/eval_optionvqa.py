...
from llava.eval.m4c_evaluator import TextVQAAccuracyEvaluator, ScienceQAAccuracyEvaluator
...
def eval_single(annotation_file, result_file):
    ...
    if annotation_file.find('scienceqa') >= 0:
        evaluator = ScienceQAAccuracyEvaluator()
    else:
