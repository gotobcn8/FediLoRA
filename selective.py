...
def fl_finetune(
    ...
    for epoch in tqdm(range(num_communication_rounds)):
        ...
        for client_id in selected_clients_set:
            ...
            if algo.lower() in NORMAL_ALGO:
                client.global_align_by_nums(epoch,local_ranks[client_id],lora_key,edit_nums)
            ...
            if epoch == num_communication_rounds - 1:
                ...
                print(f'{client_id} evaluation:{acc}')
